...
template <class T, class U>
vector<Edge<T, U> > Vertex<T, U>::getAdj() const{
	return this->adj;
}
...
public:
	...
	void getfloydWarshallPathAux(int index1, int index2, vector<T, U> & res);
};
...
template <class T, class U>
void Graph<T, U>::getfloydWarshallPathAux(int index1, int index2, vector<T, U> & res)
{
